...
{
    class SingleOrderPlaced : BaseClass
    {

        //Create SingleProduct Purchase method
        public void SpecificProductpurchase(string url,string email,string pass,string category,string keywords,string productselect,string firstname,string lastname,string housenum,string province,string city,string area, string zipcode, string phone)
        {
            //Pass URL
